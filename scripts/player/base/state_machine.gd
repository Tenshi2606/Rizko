...
func _state_default_start() -> void:
	if default_state == null:
		push_error("Default state no configurado en StateMachine!")
		return
...
func change_to(new_state: String) -> void:
	...
	if next_state == null:
		push_error("Estado no encontrado: " + new_state + ". Verifica nodos hijos de StateMachine.")
		return
...
func _state_start() -> void:
	if current_state == null:
		push_error("Current_state es null. No se puede iniciar.")
		return
